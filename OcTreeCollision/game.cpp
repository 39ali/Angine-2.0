...
Game::Game() : m_width(1024), m_height(1280), m_box_r(100), m_velocity(0.3, 3), m_velocity_max(20)
{
	...
	for (std::size_t i = 0; i < s; i++) {
		...
		for each (Particle* entity2 in *entity1->particles)
		{
			...
			if (l < entity1->radius + entity2->radius && l != 0 && entity2->isActive)
			{
				...
				addParticle(entity1->getPosition(), tempa, entity1->mass + entity2->mass);
